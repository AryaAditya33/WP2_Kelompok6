...
<div id="content">
    ...
    <div>
        <ol class="breadcrumb h3 pl-5 bg-light">
            ...
            <div class="col-xl-3 col-md-6">
                ...
                <div class="card shadow mb-4">
                    <div class="card-header py-3">
                        <h6 class="m-0 font-weight-bold text-primary">Persentase Calon Siswa Berdasarkan Asal Kota</h6>
                    </div>
                    <div class="card-body">
                        ...
                        <h4 class="small font-weight-bold">Bogor<span
                                class="float-right">8%</span></h4>
                    ...
                    <div class="card-body">
                        <div class="text-center">
                            <img class="img-fluid px-3 px-sm-4 mt-3 mb-4" style="width: 25rem;"
                                src="<?php echo base_url('img/undraw_engineering_team.svg') ?>" alt="...">
                        </div>
